...
// Helper functions
int VehicleActionBuilder::validateInputParameters(const pb_byte_t *output_buffer, const size_t *output_length) {
...
bool ParameterValidator::isValidChargingLimit(int32_t percent) { return percent >= 50 && percent <= 100; }
