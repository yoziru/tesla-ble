...
class VehicleActionBuilder {
 public:
   ...
   */
  static const std::unordered_map<pb_size_t, BuilderFunction> &getBuilders() { return builders_; }
 ...
 private:
  ...
  // Helper functions
  static int validateInputParameters(const pb_byte_t *output_buffer, const size_t *output_length);
