...
#define _Errors_GenericError_E_ARRAYSIZE \
  ((Errors_GenericError_E) (Errors_GenericError_E_GENERICERROR_NOT_ALLOWED_OVER_TRANSPORT + 1))
...
#define Errors_NominalError_FIELDLIST(X, a) X(a, STATIC, SINGULAR, UENUM, genericError, 1)
