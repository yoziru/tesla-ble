...
TEST_F(ProtocolVectorsTest, MetadataSerializationVectors) {
  ...
  uint8_t expected_vin_tlv[] = {0x02, 0x11,  // TAG_PERSONALIZATION, length 17
                                0x35, 0x59, 0x4a, 0x33, 0x30, 0x31, 0x32, 0x33, 0x34,
...
TEST_F(ProtocolVectorsTest, HmacSha256Authentication) {
  ...
  const char *test_metadata = "000105010103021135594a333031323334353637383941424303104c463f9cc0d3d26906e982ed224adde604"
