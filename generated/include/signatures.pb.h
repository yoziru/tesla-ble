...
#define _Signatures_SignatureType_ARRAYSIZE \
  ((Signatures_SignatureType) (Signatures_SignatureType_SIGNATURE_TYPE_AES_GCM_RESPONSE + 1))
...
#define _Signatures_Session_Info_Status_ARRAYSIZE \
  ((Signatures_Session_Info_Status) (Signatures_Session_Info_Status_SESSION_INFO_STATUS_KEY_NOT_ON_WHITELIST + 1))

#define Signatures_SessionInfo_status_ENUMTYPE Signatures_Session_Info_Status

/* Initializer values for message structs */
#define Signatures_KeyIdentity_init_default \
  { \
    0, { \
      { \
        0, {0} \
...
#define Signatures_HMAC_Signature_Data_init_default \
  { \
    { \
      0, {0} \
    } \
...
#define Signatures_SignatureData_init_default \
  { \
    false, Signatures_KeyIdentity_init_default, 0, { Signatures_AES_GCM_Personalized_Signature_Data_init_default } \
  }
...
#define Signatures_KeyIdentity_init_zero \
  { \
    0, { \
      { \
        0, {0} \
...
#define Signatures_HMAC_Signature_Data_init_zero \
  { \
    { \
      0, {0} \
    } \
...
#define Signatures_SignatureData_init_zero \
  { \
    false, Signatures_KeyIdentity_init_zero, 0, { Signatures_AES_GCM_Personalized_Signature_Data_init_zero } \
  }
...
#define Signatures_HMAC_Signature_Data_FIELDLIST(X, a) X(a, STATIC, SINGULAR, BYTES, tag, 1)
...
#define Signatures_SignatureData_sig_type_AES_GCM_Personalized_data_MSGTYPE \
  Signatures_AES_GCM_Personalized_Signature_Data
...
#define Signatures_GetSessionInfoRequest_FIELDLIST(X, a) X(a, STATIC, OPTIONAL, MESSAGE, key_identity, 1)
