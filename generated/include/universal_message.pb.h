...
typedef enum _UniversalMessage_MessageFault_E {
  ...
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_INVALID_DOMAINS =
      8, /* Command was malformed or addressed to an unrecognized vehicle system. May indicate client error or older
            vehicle firmware. */
  ...
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_IV_INCORRECT_LENGTH =
      16, /* Initialization Value length is incorrect (AES-GCM must use 12-byte IVs). Indicates a client programming
             error. */
  ...
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_TIME_TO_LIVE_TOO_LONG =
      20, /* Vehicle rejected command because its expiration time was too far in the future. This is a security
             precaution. */
  ...
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_REMOTE_SERVICE_ACCESS_DISABLED =
      22, /* The command was authorized with a Service key, but the vehicle has not been configured to permit remote
             service commands. */
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_COMMAND_REQUIRES_ACCOUNT_CREDENTIALS =
      23, /* The command requires proof of Tesla account credentials but was not sent over a channel that provides this
             proof. Resend the command using Fleet API. */
...
#define _UniversalMessage_OperationStatus_E_ARRAYSIZE \
  ((UniversalMessage_OperationStatus_E) (UniversalMessage_OperationStatus_E_OPERATIONSTATUS_ERROR + 1))

#define _UniversalMessage_MessageFault_E_MIN UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_NONE
#define _UniversalMessage_MessageFault_E_MAX \
  UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_REQUIRES_RESPONSE_ENCRYPTION
#define _UniversalMessage_MessageFault_E_ARRAYSIZE \
  ((UniversalMessage_MessageFault_E) (UniversalMessage_MessageFault_E_MESSAGEFAULT_ERROR_REQUIRES_RESPONSE_ENCRYPTION + \
                                      1))
...
#define UniversalMessage_Destination_init_default \
  { \
    0, { _UniversalMessage_Domain_MIN } \
  }
#define UniversalMessage_MessageStatus_init_default \
  {_UniversalMessage_OperationStatus_E_MIN, _UniversalMessage_MessageFault_E_MIN}
#define UniversalMessage_SessionInfoRequest_init_default \
  { \
    {0, {0}}, { 0, {0} } \
  }
#define UniversalMessage_RoutableMessage_init_default \
  {false,    UniversalMessage_Destination_init_default, \
   false,    UniversalMessage_Destination_init_default, \
   0,        {{0, {0}}}, \
   false,    UniversalMessage_MessageStatus_init_default, \
   0,        {Signatures_SignatureData_init_default}, \
   {0, {0}}, {0, {0}}, \
   0}
#define UniversalMessage_Destination_init_zero \
  { \
    0, { _UniversalMessage_Domain_MIN } \
  }
#define UniversalMessage_MessageStatus_init_zero \
  {_UniversalMessage_OperationStatus_E_MIN, _UniversalMessage_MessageFault_E_MIN}
#define UniversalMessage_SessionInfoRequest_init_zero \
  { \
    {0, {0}}, { 0, {0} } \
  }
#define UniversalMessage_RoutableMessage_init_zero \
  { \
      false,    UniversalMessage_Destination_init_zero, \
      false,    UniversalMessage_Destination_init_zero, \
      0,        {{0, {0}}}, \
      false,    UniversalMessage_MessageStatus_init_zero, \
      0,        {Signatures_SignatureData_init_zero}, \
      {0, {0}}, {0, {0}}, \
      0}
